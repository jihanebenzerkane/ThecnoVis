    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Equipement>().HasData(
                new Equipement { Id = 1, SerialNumber = "EQ-HVAC-901", Nom = "Groupe Froid Trane Centravac", Categorie = "HVAC", SiteId = 1, DateInstallation = new DateTime(2020, 4, 12), Criticiticite = 5, ScoreSante = 78, ScoreRisque = 38, Statut = "Opérationnel", DerniereVisite = DateTime.Now.AddDays(-28), ProchaineVisitePrevue = DateTime.Now.AddDays(2) },
                new Equipement { Id = 2, SerialNumber = "EQ-GE-404", Nom = "Groupe Électrogène Caterpillar 1500kVA", Categorie = "Groupe Électrogène", SiteId = 3, DateInstallation = new DateTime(2019, 11, 5), Criticiticite = 5, ScoreSante = 62, ScoreRisque = 74, Statut = "Maintenance Requise", DerniereVisite = DateTime.Now.AddDays(-45), ProchaineVisitePrevue = DateTime.Now.AddDays(-3) },
                new Equipement { Id = 3, SerialNumber = "EQ-TRF-208", Nom = "Transformateur Schneider Triphasé 20kV", Categorie = "Transformateur", SiteId = 2, DateInstallation = new DateTime(2018, 6, 20), Criticiticite = 4, ScoreSante = 91, ScoreRisque = 18, Statut = "Opérationnel", DerniereVisite = DateTime.Now.AddDays(-15), ProchaineVisitePrevue = DateTime.Now.AddDays(15) },
                new Equipement { Id = 4, SerialNumber = "EQ-CMP-302", Nom = "Compresseur Atlas Copco GA75", Categorie = "Compresseur", SiteId = 2, DateInstallation = new DateTime(2021, 8, 30), Criticiticite = 3, ScoreSante = 85, ScoreRisque = 22, Statut = "Opérationnel", DerniereVisite = DateTime.Now.AddDays(-10), ProchaineVisitePrevue = DateTime.Now.AddDays(20) },
                new Equipement { Id = 5, SerialNumber = "EQ-TGBT-101", Nom = "Armoire TGBT Principal Masterpact", Categorie = "TGBT", SiteId = 1, DateInstallation = new DateTime(2017, 2, 14), Criticiticite = 5, ScoreSante = 55, ScoreRisque = 82, Statut = "En Révision", DerniereVisite = DateTime.Now.AddDays(-60), ProchaineVisitePrevue = DateTime.Now.AddDays(1) }
            );

            // Seed Visites
            modelBuilder.Entity<Visite>().HasData(
                new Visite { Id = 1, Reference = "VIS-2026-1001", TypeVisite = "Préventive", EquipementId = 1, TechnicienAssigne = "Amine El Amrani", DatePrevue = DateTime.Now.AddDays(2), DureeEstimeeMinutes = 120, Statut = "Planifiée", ScorePriorite = 65.5, RapportTechnique = "", ActionsCorrectives = "" },
                new Visite { Id = 2, Reference = "VIS-2026-1002", TypeVisite = "Curative", EquipementId = 2, TechnicienAssigne = "Hassan Chraibi", DatePrevue = DateTime.Now.AddDays(-3), DureeEstimeeMinutes = 180, Statut = "En retard", ScorePriorite = 92.0, RapportTechnique = "Alerte pression huile moteur au démarrage.", ActionsCorrectives = "Remplacement filtre huile et purge système." },
                new Visite { Id = 3, Reference = "VIS-2026-1003", TypeVisite = "Audit", EquipementId = 3, TechnicienAssigne = "Nadia Berrada", DatePrevue = DateTime.Now.AddDays(-5), DateRealisee = DateTime.Now.AddDays(-5), DureeEstimeeMinutes = 90, Statut = "Validée", ScorePriorite = 45.0, RapportTechnique = "Analyse diélectrique huile conforme.", ActionsCorrectives = "Rien à signaler." },
                new Visite { Id = 4, Reference = "VIS-2026-1004", TypeVisite = "Préventive", EquipementId = 5, TechnicienAssigne = "Amine El Amrani", DatePrevue = DateTime.Now.AddDays(1), DureeEstimeeMinutes = 150, Statut = "Planifiée", ScorePriorite = 88.5, RapportTechnique = "", ActionsCorrectives = "" }
            );
        }
    }
}
